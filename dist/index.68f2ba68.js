...
})({"7sY8H":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "d9588b6868f2ba68";
"use strict";
...
},{}],"kGoSG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _modelJs = require("./model.js");
var _observeJs = require("./view/observe.js");
var _top5MovieViewJs = require("./view/top5MovieView.js");
var _top5MovieViewJsDefault = parcelHelpers.interopDefault(_top5MovieViewJs);
var _movieTrendingVIewJs = require("./view/MovieTrendingVIew.js");
var _movieTrendingVIewJsDefault = parcelHelpers.interopDefault(_movieTrendingVIewJs);
var _searchMovieJs = require("./view/searchMovie.js");
var _searchMovieJsDefault = parcelHelpers.interopDefault(_searchMovieJs);
var _movieReviewJs = require("./view/movieReview.js");
var _movieReviewJsDefault = parcelHelpers.interopDefault(_movieReviewJs);
var _stable = require("core-js/stable");
var _regeneratorRuntime = require("regenerator-runtime");
const top5Movie = async function() {
    const data = await _modelJs.getMovieTop5();
    const top5 = data.results.slice(0, 5);
    _top5MovieViewJsDefault.default.render(top5);
};
const MovieTrending = async function() {
    const data = await _modelJs.getMovieTrending();
    const top5 = data.results.slice(0, 5);
    _movieTrendingVIewJsDefault.default.render(top5);
};
const searchMovie = async function() {
    try {
        const query = _searchMovieJsDefault.default.getQuery();
        if (!query) return;
        const data = await _modelJs.SearchMovie(query);
        _searchMovieJsDefault.default.render(data.results);
    } catch (err) {
        throw err;
    }
};
const getMovieBYID = async function() {
    try {
        ...
        await _modelJs.getMovieID(movie_id);
        _movieReviewJsDefault.default.render(_modelJs.state);
    } catch (err) {
        throw err;
    }
};
const init = function() {
    ...
    if (location.pathname === '/search-movie.html') _searchMovieJsDefault.default._addHandlerSearch(searchMovie);
};
init(); // Start App

},{"./model.js":"eogeN","./view/top5MovieView.js":"97mlb","./view/MovieTrendingVIew.js":"j5uhE","core-js/stable":"95FYz","regenerator-runtime":"1EBPE","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./view/observe.js":"3tkzd","./view/searchMovie.js":"hVzUy","./view/movieReview.js":"gZl8h"}],"eogeN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "getMovieTop5", ()=>getMovieTop5
);
parcelHelpers.export(exports, "getMovieTrending", ()=>getMovieTrending
);
parcelHelpers.export(exports, "SearchMovie", ()=>SearchMovie
);
parcelHelpers.export(exports, "getMovieID", ()=>getMovieID
);
...
const getMovieTop5 = async function() {
    const data = await _helpersJs.getJSON(`https://api.themoviedb.org/3/movie/top_rated`);
    return data;
};
const getMovieTrending = async function() {
    const data = await _helpersJs.getJSON(`https://api.themoviedb.org/3/trending/movie/day`);
    return data;
};
const SearchMovie = async function(movie) {
    const data = await _helpersJs.getJSONSearch(undefined, movie);
    return data;
};
const getMovieID = async function(movie_id) {
    const data = await _helpersJs.getJSON_BY_ID(movie_id);
    const TrailerID = await _helpersJs.getJSON_Trailer(movie_id);
    state.query.movie = data;
    state.query.Trailer = TrailerID;
    return data;
};

},{"./helpers.js":"fSkXd","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fSkXd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getJSON", ()=>getJSON
);
parcelHelpers.export(exports, "getJSONSearch", ()=>getJSONSearch
);
parcelHelpers.export(exports, "getJSON_BY_ID", ()=>getJSON_BY_ID
);
parcelHelpers.export(exports, "getJSON_Trailer", ()=>getJSON_Trailer
);
var _configJs = require("./config.js");
const getJSON = async function(url, api = _configJs.API_KEY) {
    try {
...
const getJSONSearch = async function(api = _configJs.API_KEY, queryMovie) {
    try {
...
const getJSON_BY_ID = async function(movie_id, api = _configJs.API_KEY) {
    try {
        const res = await fetch(`https://api.themoviedb.org/3/movie/${movie_id}?api_key=${api}`);
        if (!res.ok) throw new Error(`error ${res.status}`);
        const data = await res.json();
        return data;
    } catch (err) {
...
const getJSON_Trailer = async function(Trailer_id, api = _configJs.API_KEY) {
    try {
        const res = await fetch(`https://api.themoviedb.org/3/movie/${Trailer_id}/videos?api_key=${api}`);
        if (!res.ok) throw new Error(`error ${res.status}`);
        const data = await res.json();
        return data;
    } catch (err) {
...
},{"./config.js":"kIsc0","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kIsc0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY
);
const API_KEY = 'b08d7d244b2fedadfbf84e0053742c94';
...
},{}],"97mlb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class top5Movie extends _viewJsDefault.default {
...
exports.default = new top5Movie();

},{"./View.js":"h0JSh","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"h0JSh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"j5uhE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class TrendingMovie extends _viewJsDefault.default {
...
exports.default = new TrendingMovie();

},{"./View.js":"h0JSh","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"95FYz":[function(require,module,exports) {
...
},{}],"3tkzd":[function(require,module,exports) {
...
},{}],"hVzUy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class SearchMovieView extends _viewJsDefault.default {
...
exports.default = new SearchMovieView();

},{"./View.js":"h0JSh","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"gZl8h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class top5Movie {
    _data;
    ...
    <div class="row g-0">
      <div class="col-md-4">
        ...
        <div>
          ...
          <hr />
          <h6>genres : ${movie.genres.map((lang)=>lang.name
        )}</h6>
          <hr />
          <h6>languages : ${movie.spoken_languages.map((lang)=>lang.name
        )}</h6>
        </div>
      </div>
      <div class="col-md-8">
        <div class="card-body">
          ...
          <hr />
          ${Trailer.results.length === 0 ? '<h5 class="text-center">No Trailler</h5>' : `<iframe
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["7sY8H","kGoSG"], "kGoSG", "parcelRequire7e89")

//# sourceMappingURL=index.68f2ba68.js.map
